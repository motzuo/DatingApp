...
namespace API.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        {
            var self = User.GetUsername() == username;
            return await _unitOfWork.UserRepository.GetMemberAsync(username, self);
        }

        [HttpPut]
        public async Task<ActionResult> UpdateUser(MemberUpdateDto memberUpdateDto)
        {
            var user = await _unitOfWork.UserRepository.GetUserByUsernameAsync(GetUsername());
        ...
        {
            var user = await _unitOfWork.UserRepository.GetUserByUsernameAsync(GetUsername(), true);
